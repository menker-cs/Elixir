...
namespace Elixir.Mods
{
    ...
    public class ModButtons
    {
        public static Button[] buttons =
        {
            ...
            new Button("Force Tag Freeze", Category.Move, false, false, ()=>TagFreeze(), null),
            new Button("No Tag Freeze", Category.Move, true, false, ()=>NoTagFreeze(), null),
            ...
            new Button("Super Monke [P]", Category.Move, true, false, ()=>SuperMonke(), ()=>UseGravity(true)),
