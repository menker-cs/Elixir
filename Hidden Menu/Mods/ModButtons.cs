...
namespace Hidden.Mods
{
    ...
    public class ModButtons
    {
        public static Button[] buttons =
        {
            ...
            new Button("Join Menu Code", Category.Room, false, false, ()=>JoinRoom("$HIDDEN$")),
            ...
            new Button("Punch Mod [BUGGY]", Category.Move, true, false, ()=>PunchMod()),
            ...
            new Button("Jupiter Walk", Category.Move, true, false, ()=>JupiterWalk()),
